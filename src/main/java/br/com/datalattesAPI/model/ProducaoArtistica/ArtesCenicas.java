...
public class ArtesCenicas extends Auxiliar {
	String natureza;
	String titulo;
	String ano;
	String pais;
	...
	String flagItinerante;

	public ArtesCenicas(Autores autores, PalavraChave palavraChave, SetorAtividade setorAtividade,
			...
			String flagDivulgacaoCientifica, String tipoDeEvento, String atividadeDosAutores, String dataEstreia,
			String dataEncerramento, String localDeEstreia, String premiacao, String instituicaoPromotoraDoPremio,
			String obraDeReferencia, String autorDaObraDeReferencia, String anoDaObraDeReferencia, String duracao,
			String temporada, String instituicaoPromotoraDoEvento, String localDoEvento, String cidadeDoEvento,
			String flagItinerante) {
