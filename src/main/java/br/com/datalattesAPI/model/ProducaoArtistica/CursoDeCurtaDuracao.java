...
public class CursoDeCurtaDuracao extends Auxiliar {
	String natureza;
	String titulo;
	String ano;
	String pais;
	...
	public CursoDeCurtaDuracao(Autores autores, PalavraChave palavraChave, SetorAtividade setorAtividade,
			...
			String duracao, String unidade, String instituicaoPromotoraDoEvento, String localDoEvento, String cidade) {
