 ...
 * 
 */
public class OutrasOrientacaoConcluida extends OrientacaoAbstract {

	public String tipo;

	public OutrasOrientacaoConcluida(PalavraChave palavraChave, SetorAtividade setorAtividade,
