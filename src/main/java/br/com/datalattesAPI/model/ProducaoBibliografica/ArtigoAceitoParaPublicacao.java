...
public class ArtigoAceitoParaPublicacao extends Auxiliar {
	String natureza;
	...
	public ArtigoAceitoParaPublicacao(Autores autores, PalavraChave palavraChave, SetorAtividade setorAtividade,
	...
	public String toString() {
		return "ArtigoAceitoParaPublicacao [" + (this.natureza != null ? "natureza=" + this.natureza + ", " : "")
