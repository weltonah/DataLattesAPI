...
public class Editoracao extends Auxiliar {
	String natureza;
	String titulo;
	String ano;
	String pais;
	...
	public Editoracao(Autores autores, PalavraChave palavraChave, SetorAtividade setorAtividade,
			...
			String numeroDePaginas, String instituicaoPromotora, String editora, String cidade) {
